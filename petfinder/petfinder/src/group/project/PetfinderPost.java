...
public class PetfinderPost extends Activity{
 ...
 //parameterized Constructor to initialize members with user input
     ...
     public PetfinderPost(String atype, String abreed, String asize, String acolor, String acomment, String apicture)
